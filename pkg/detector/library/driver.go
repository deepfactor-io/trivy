...
import (
	...
	"github.com/deepfactor-io/trivy/v3/pkg/detector/library/compare"
	"github.com/deepfactor-io/trivy/v3/pkg/detector/library/compare/bitnami"
	"github.com/deepfactor-io/trivy/v3/pkg/detector/library/compare/maven"
	"github.com/deepfactor-io/trivy/v3/pkg/detector/library/compare/npm"
	"github.com/deepfactor-io/trivy/v3/pkg/detector/library/compare/pep440"
...
func NewDriver(libType ftypes.LangType) (Driver, bool) {
	...
	case ftypes.Composer, ftypes.ComposerInstalled, ftypes.ComposerJSON, ftypes.ComposerVendor:
