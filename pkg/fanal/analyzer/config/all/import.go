...
import (
	...
	_ "github.com/deepfactor-io/trivy/v3/pkg/fanal/analyzer/config/terraformplan/json"
	_ "github.com/deepfactor-io/trivy/v3/pkg/fanal/analyzer/config/terraformplan/snapshot"
)
