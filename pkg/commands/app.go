...
import (
	...
	"github.com/deepfactor-io/trivy/v3/pkg/commands/artifact"
	"github.com/deepfactor-io/trivy/v3/pkg/commands/clean"
	"github.com/deepfactor-io/trivy/v3/pkg/commands/convert"
	"github.com/deepfactor-io/trivy/v3/pkg/commands/server"
	"github.com/deepfactor-io/trivy/v3/pkg/fanal/analyzer"
	"github.com/deepfactor-io/trivy/v3/pkg/flag"
	k8scommands "github.com/deepfactor-io/trivy/v3/pkg/k8s/commands"
...
func NewClientCommand(globalFlags *flag.GlobalFlagGroup) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			log.Warn("'client' subcommand is deprecated now. See https://github.com/deepfactor-io/trivy/discussions/2119")
